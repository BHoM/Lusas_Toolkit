...
Public Class mesh_line_len_no_release
    ...
    Public Sub New()
        MyBase.New(“line_mesh_len_no_release", "l_m_l_n_r",
                   "Create a line mesh using element length with no end releases",
    ...
    Public Overrides ReadOnly Property ComponentGuid() As Guid
        Get
            Return New Guid("{c6aa2e29-9721-44d3-861e-c8cd99a36cd5}")
        End Get
    End Property

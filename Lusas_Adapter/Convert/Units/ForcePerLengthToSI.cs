    ...
    public static partial class Convert
    {
        ...
        public static double ForcePerLengthToSI(this double forcePerLength, string forceUnit, string lengthUnit)
        {
            switch (forceUnit)
            {
                case "N":
                    switch (lengthUnit)
                    {
                        ...
                        case "IN":
                            throw new Exception("No conversion method found for" + forceUnit + " " + lengthUnit);
                        default:
                            Compute.RecordWarning("No length unit detected, Lusas pressure unit assumed to be set to Newtons per square metre.Therefore no unit conversion will occur.");
                            break;
                    }
                    break;
                case "KN":
                    switch (lengthUnit)
                    {
                        ...
                        case "IN":
                            throw new Exception("No conversion method found for" + forceUnit + " " + lengthUnit);
                        default:
                            Compute.RecordWarning("No length unit detected, Lusas length unit assumed to be set to metres.");
                ...
                default:
                    Compute.RecordWarning("No force unit detected, Lusas force unit assumed to be set to Newtons. Therefore no unit conversion will occur. ");
                    break;
            }
